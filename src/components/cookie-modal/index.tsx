					...
					<div class="relative flex flex-col rounded-xl bg-white shadow-lg dark:bg-neutral-900">
						<div class="absolute end-2 top-2">
							...
							>
								...
								>
									<title>Exit Recommeded Cookies Settings</title>
									<path d="M18 6 6 18" />
									<path d="m6 6 12 12" />
								</svg>
							</button>
						...
						<div class="overflow-y-auto p-4 text-center sm:p-14">
							<svg
								class="mx-auto mb-4 h-auto w-20"
								width="72"
								height="63"
								viewBox="0 0 72 63"
								fill="none"
								xmlns="http://www.w3.org/2000/svg"
							>
								<title>Image of Litteral Cookie</title>
								<path
									...
									class="stroke-gray-800 dark:stroke-neutral-200"
									stroke="currentColor"
									stroke-width="2"
									stroke-linecap="round"
								/>
						...
						<div class="flex items-center">
							...
							<button
								type="button"
								class="inline-flex w-full items-center justify-center gap-x-2 rounded-ee-xl border border-transparent bg-blue-600 px-4 py-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-50"
								data-hs-overlay="#hs-cookies"
							>
								Got it
							</button>
